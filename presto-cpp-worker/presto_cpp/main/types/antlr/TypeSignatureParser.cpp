  ...
  try {
    ...
    switch (getInterpreter<atn::ParserATNSimulator>()->adaptivePredict(
      ...
      case 1: {
        ...
        if (!(isVar()))
          throw FailedPredicateException(this, " isVar() ");
        setState(42);
...
TypeSignatureParser::Row_typeContext* TypeSignatureParser::row_type() {
  ...
  try {
    ...
    if (!(isRow()))
      throw FailedPredicateException(this, " isRow() ");
    setState(64);
    match(TypeSignatureParser::WORD);
    setState(65);
    match(TypeSignatureParser::T__0);
...
TypeSignatureParser::Map_typeContext* TypeSignatureParser::map_type() {
  ...
  try {
    ...
    if (!(isMap()))
      throw FailedPredicateException(this, " isMap() ");
    setState(70);
    match(TypeSignatureParser::WORD);
    setState(71);
    match(TypeSignatureParser::T__0);
...
TypeSignatureParser::Array_typeContext* TypeSignatureParser::array_type() {
  ...
  try {
    ...
    if (!(isArray()))
      throw FailedPredicateException(this, " isArray() ");
    setState(78);
    match(TypeSignatureParser::WORD);
    setState(79);
    match(TypeSignatureParser::T__0);

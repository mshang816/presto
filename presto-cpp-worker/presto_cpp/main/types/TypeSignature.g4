...
@parser::declarations {
    ...
    #define isRow()         (UpCase(Token()) == "ROW")
    #define isMap()         (UpCase(Token()) == "MAP")
    #define isArray()       (UpCase(Token()) == "ARRAY")
    #define isVar()         (UpCase(Token()) == "VARCHAR" || UpCase(Token()) == "VARBINARY")
}
...
row_type :
    { isRow() }? WORD '(' type_list ')' ;

map_type :
    { isMap() }? WORD '(' type ',' type ')' ;
